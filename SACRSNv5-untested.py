...
def train():
    ...
    print(f"--- Features: Graph Bias | ACT | Consistency Reg | Scheduler ---")
    ...
    try:
        for epoch in range(CONFIG["epochs"]):
            ...
            for i in range(0, len(data_tensor) - 1):
                ...
                # 1. Output Entropy (Prevent dead symbols)
                ...
                loss = loss_pred + loss_ponder + 0.1 * vq_loss + loss_entropy + loss_consistency
...
# ==========================================
# 8. Logic Rule Extractor (From v3)
# ==========================================
...
if __name__ == "__main__":
    FILENAME = "crsn_master_model_v4.pth"
